$(document).ready(function(){
  ...
  $.fn.tweet = function(o){
    ...
    function remove_duplicate_users(tweets) {

      var foundUsers = [];
      var uniqueTweets = [];
      var duplicateTweets = [];

      $.each(tweets, function(index, el) {
        if($.inArray(el.screen_name, foundUsers) < 0) {
          foundUsers.push(el.screen_name);
          uniqueTweets.push(el);
        }
        else {
          duplicateTweets.push(el);
        }
      });
      return uniqueTweets;
    }
    ...
    function extract_template_data(item){
      ...
      o.avatar = o.avatar_size ?
        t('<a class="tweet_avatar" href="{user_url}"><img class="tweet_avatar_img" src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0"/></a>', o) : '';
